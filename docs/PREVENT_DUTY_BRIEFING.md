# OroQ & the Prevent Duty – Briefing Note (Draft)

Audience: Designated OroQing Leads (DSLs), Prevent leads, senior leadership  
Version: Draft – 0.3.0 (extension), 2025-02-14

## Purpose
Summarise how OroQ (OroQ AI) contributes to your organisation’s compliance with the Prevent Duty (Counter-Terrorism and Security Act 2015) and outline recommended operational practices.

## OroQ capabilities relevant to Prevent
...
5. **Educate staff and learners** – brief staff that OroQ blocks extremist content and instruct them on how to escalate concerns. Signpost pupils to CEOP/Childline reporting routes in your digital citizenship curriculum.  
6. **Review network layers** – OroQ complements (not replaces) ISP or firewall filtering. Ensure overlaps don’t create blind spots (e.g., whitelisted domains bypassing upstream filters).

### Quick checklist for DSLs
- [ ] Insert OroQ into your Prevent risk assessment, with owner and review cadence.  
...
- [ ] Update staff briefing pack to mention OroQ’s PIN process and escalation route.  
...
- Reference OroQ in your Prevent risk assessment, noting its on-device nature and minimal data processing.
...
For collaboration or feedback, open a Prevent-tagged issue or discussion on GitHub: https://github.com/DipesThapa/oroq.
