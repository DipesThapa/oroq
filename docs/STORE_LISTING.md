...
## Full Description
OroQ helps families and schools reduce exposure to harmful content. It blocks adult sites, enforces SafeSearch on Google/Bing, and can blur images/videos on the page using on‑device heuristics. No data leaves your device.
...
- OroQing digest: download weekly CSV summaries for DSLs, governors, and audit trails
...
- assets/store/screenshot-4-aggressive-mode.png — Blurred image/video with “Blocked by OroQ” tag
