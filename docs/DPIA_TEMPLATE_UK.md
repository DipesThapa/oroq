# OroQ (OroQ AI) DPIA Template – UK Schools
...
## 1. Project overview
- **Product**: OroQ (OroQ AI) Chrome extension  
...
| Inadequate audit trail for inspectors | Medium | Medium | Use OroQ override log (download termly) and retain exported policy lists. | Low/Medium |
| Accessibility barriers (screen readers) | Low | Medium | Test with ChromeVox/JAWS; document user guidance. | Low |

## 5. Consultation
- **OroQing team/DSL** – date & outcome  
...
- **Related documents**: OroQ KCSIE matrix, Prevent briefing, Acceptable Use Policy, Incident response plan.

## 7. Actions / enhancements
- [ ] Import Prevent keyword pack once available.  
- [ ] Enable override reason capture / logs (planned feature).  
- [ ] Attach evidence of staff training on OroQ usage.  
- [ ] Update privacy notice to reference client-side filtering tool.

> For questions or community templates, visit the project repo: https://github.com/DipesThapa/oroq.
