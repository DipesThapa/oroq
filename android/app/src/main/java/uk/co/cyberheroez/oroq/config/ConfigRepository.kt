...
/**
 * Persists child-device configuration: enabled blocklist categories, blocked /
 * approved apps, per-app schedules, screen-time limits, and the clock-tamper
 * anchor. All reads/writes are suspending.
 */
