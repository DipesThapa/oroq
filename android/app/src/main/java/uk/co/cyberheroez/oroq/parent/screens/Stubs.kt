...
@Composable fun HomeScreen(vm: ParentViewModel, nav: NavController) { Text("home", style = OroqType.BodyOnDark) }
@Composable fun ActivityScreen(vm: ParentViewModel) { Text("activity", style = OroqType.BodyOnDark) }
